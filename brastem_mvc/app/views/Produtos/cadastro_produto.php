					...
					<div class="rows">
							<div class="col-12 pt-2 d-flex text-between">
								...
								<div class="col-8 mb-3">
									...
									<input type="text" name="produto" class="form-campo" placeholder="Digite o nome do Produto" required>
								...
								<div class="col-3 mb-3">
									...
									<input type="text" name="codigo" class="form-campo" placeholder="Digite o Código do Produto" required>
								...
								<div class="col-3 mb-3">
									...
									<input type="text" name="estoque" class="form-campo" placeholder="Digite a quantidade de Produtos no Estoque" required>
								...
								<div class="col-3 mb-3">
									...
									<input type="text" name="preco" class="form-campo" placeholder="R$ 0,00" required>
									<!-- <small href="" class="msg msg-vermelho h6 mt-1 p-1"><i class="fas fa-exclamation-triangle"></i> O Campo <b>estoque estadual</b> é obrigatório <a href="javascript:;" onclick="fecharMsg()" class="fas fa-times float-right"></a></small> -->
